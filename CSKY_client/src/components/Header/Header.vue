  ...
  <header class="header" v-if="$route.meta.isShowHeader" >
    ...
    <el-row :gutter="20">
      <el-col :span="20" :offset="2">
        <el-menu :default-active="$route.path" class="top" mode="horizontal" background-color="#ffffff"
          ...
          <el-menu-item index="/testList">刷题</el-menu-item>
          <el-submenu index="/home">
            <template slot="title" >考研信息</template>
            <el-menu-item index="/home">信息中心</el-menu-item>
          ...
          <el-menu-item index="/user" v-if="username" style="float: right">个人主页</el-menu-item>
    ...
    <div class="bottom" v-if="$route.meta.isShowSearch">
      <el-row :gutter="20" >
        ...
        <el-col :xs="4" :sm="3" :md="9" :lg="9" :xl="2" style="margin-bottom: 50px !important;">
          <router-link to="/home">
            <img
                src="../../assets/logo.png"
                alt="logo"
