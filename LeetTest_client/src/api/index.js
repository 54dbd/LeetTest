...
//获取测试题目列表
export const reqGetTestList = (data)=>requests({
    url:'/test/list',
    method:'post',
    data
})
...
// 搜索题目
export const reqSearchTest = (data)=>requests({
    url: '/test/query',
    method: 'post',
    data
})
...
// 获取某一考试具体信息
export const reqGetTestDetailByTid = (tid)=>requests({
    url: `/test/detail/${tid}`,
    method: 'get'
})
...
//通过question_id获取评论
export const reqGetTestCommentByQuestionid =(questionid)=>requests({
    url:`/test/comment/${questionid}`,
    method:'get'
})

//通过sname获取错题
export const reqGetProblemCollectionBySname=(sname,userid)=>requests({
...
//提交错题
export const reqSaveHistory=(data)=>requests({
...
//获取评论列表
export const reqGetTestCommentList = (data)=>requests({
...
//设置做题数
export const setNumByAid =(data)=>requests({
    url:'/test/addNum',
    method:'post',
    data,
...
export const reqGetNumById=(userid)=>requests({
    url:`/user/num/${userid}`,
    method:'get'
})

export const reqGetCorrectById=(userid)=>requests({
