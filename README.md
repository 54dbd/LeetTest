<h1 align="center">LeetTest 😍</h1>

![](https://s3.bmp.ovh/imgs/2022/07/13/ae47e07acbea20b7.png)
> 2022-2023 学年春季学期《Java EE开发技术》 
> 
>**LeetTest (考研刷题网)**
...
2. 数据库部分
   - 执行项目路径下`/LeetTest_db/LeetTest.sql`脚本文件
   - 修改项目路径下`/LeetTest_server/api/main/resources/application.yml`中的数据库配置

3. 后端启动
   - 使用IDE自动导入相应的Jar包
   - 启动后端项目，默认端口号80，可以在项目路径下`/LeetTest_server/api/main/resources/application.yml`修改配置
