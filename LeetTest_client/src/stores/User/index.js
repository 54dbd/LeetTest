...
// import { reqGetUserInfo, reqLogin, reqRegister } from "@/api";
...
//         console.log("[DEBUG]result.data.data.TOKEN:",result.data.data)
//         // this.LOGIN(undefined,result.data.data.TOKEN);
