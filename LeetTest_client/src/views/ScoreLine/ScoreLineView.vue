<script setup>
import { reqGetScoreLineList } from "@/api";
    ...
    <div class="row mx-md-6">
      ...
      >
        <el-table-column
          ...
          width="60"
        ></el-table-column>
        <el-table-column fixed label="学校名称" width="140">
        ...
        <el-table-column
          ...
          width="100"
        ></el-table-column>
        <el-table-column prop="majorDir" label="专业方向" width="90">
          <template v-slot:default="scope">
        ...
        <el-table-column prop="mathSubject" label="数学科目" width="100">
        </el-table-column>
        <el-table-column prop="englishSubject" label="英语科目" width="100">
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getScoreLineList() {
      const result = await reqGetScoreLineList({
